...
This is a research project in early development stages. The repository
currently contains: - Documentation and design specifications (no
implementation yet) - Git history not yet initialized on main branch -
