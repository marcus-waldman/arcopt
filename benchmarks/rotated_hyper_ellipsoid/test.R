# Test Rotated Hyper-Ellipsoid Function Derivatives
# ===================================================
#
...
cat("="[rep(1, 60)], "\n", sep = "")
cat("Testing Rotated Hyper-Ellipsoid Function\n")
cat("="[rep(1, 60)], "\n\n", sep = "")
...
# Check gradient
cat("Gradient check:\n")
grad_check <- check_gradient(rotated_hyper_ellipsoid_fn, rotated_hyper_ellipsoid_gr, x1)
cat("  Max difference:", sprintf("%.2e", grad_check$max_diff), "\n")
cat("  Passed:        ", grad_check$passed, "\n\n")

# Check Hessian
cat("Hessian check:\n")
hess_check <- check_hessian(rotated_hyper_ellipsoid_gr, rotated_hyper_ellipsoid_hess, x1)
...
grad_check2 <- check_gradient(rotated_hyper_ellipsoid_fn, rotated_hyper_ellipsoid_gr, x2)
cat("Gradient check:\n")
cat("  Max difference:", sprintf("%.2e", grad_check2$max_diff), "\n")
cat("  Passed:        ", grad_check2$passed, "\n\n")

hess_check2 <- check_hessian(rotated_hyper_ellipsoid_gr, rotated_hyper_ellipsoid_hess, x2)
cat("Hessian check:\n")
...
# Test point 3: Higher dimension (very ill-conditioned)
x3 <- rnorm(20)
cat("Test 3: High dimension (R^20, very ill-conditioned)\n")

grad_check3 <- check_gradient(rotated_hyper_ellipsoid_fn, rotated_hyper_ellipsoid_gr, x3)
cat("Gradient check:\n")
cat("  Max difference:", sprintf("%.2e", grad_check3$max_diff), "\n")
cat("  Passed:        ", grad_check3$passed, "\n\n")

hess_check3 <- check_hessian(rotated_hyper_ellipsoid_gr, rotated_hyper_ellipsoid_hess, x3)
cat("Hessian check:\n")
